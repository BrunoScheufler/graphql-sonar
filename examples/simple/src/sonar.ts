...
export type FetchPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, title?: Maybe<string>, createdAt: any }> };
...
/**
 * Run the `fetchPosts` query against a configured endpoint.
 * 
 * @param config Sonar config containing endpoint, headers, and other request options.
 * @param variables Query operation variables
 * 
 * @returns Sonar result
 */
export async function fetchPosts (config: SonarConfig, variables: FetchPostsQueryVariables) {
    return performGraphQLRequest<FetchPostsQuery>(config, {
